...
struct WiFiClient : Client {
    int connect([[maybe_unused]] IPAddress ip, [[maybe_unused]] std::uint16_t port) override { return 0; }
    ...
    SMCE__NODISCARD int available() override { return 0; }
    int read() override { return -1; }
    int read([[maybe_unused]] std::uint8_t* buf, [[maybe_unused]] std::size_t size) override { return 0; }
    SMCE__NODISCARD int peek() override { return -1; }
    void flush() override {}
    void stop() override {}
    SMCE__NODISCARD std::uint8_t connected() override { return 0; }
    SMCE__NODISCARD operator bool() override { return false; }
